// ============================================================
// /portal/followup — Followup (Accounts) Dashboard.
// ============================================================
// Hero KPI + secondary KPI row + tier distribution + last refresh
// card. Was previously at /portal but moved here when the Personal
// department became the default landing for every user.
// ============================================================
...
export default function DashboardPage() {
  ...
  return (
    <AppShell title="Followup Dashboard" crumb="Followup · Overview">
