// ============================================================
// /api/me/documents/[id] — stream (GET) or remove (DELETE) ONE of my docs.
// ============================================================
...
import { getFileWithContent, getFileMeta, deleteFile } from '@/lib/files';
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  if (req.method === 'DELETE') {
    ...
    await deleteFile(id);
    audit(req, user, 'DOCUMENT_DELETE', row.kind || 'other', { fileId: id, fileName: row.fileName });
