...
const SECTIONS: NavSection[] = [
  ...
  // admin oversight) get this; the Forms/Queries module lands here too.
  {
    ...
    items: [
      ...
      { view: 'vendors',       label: 'Vendors',            href: '/portal/vendors',      roles: ['owner','admin','cm-accounts','accounts'],          dept: 'accounts', icon: <svg viewBox="0 0 24 24"><path d="M3 9l1-5h16l1 5"/><path d="M4 9v11h16V9"/><path d="M9 20v-6h6v6"/></svg> },
